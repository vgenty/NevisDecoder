...
#include <sstream>
#include <deque>
#include "decode_algo_exception.h"
...
namespace larlite {
  ...
  */
  class algo_base : public larlite_base {
  ...
  public:
    ...
    */
    ...
    {if(word) return fem::kUNDEFINED_WORD; else return fem::kUNDEFINED_WORD;};
    ...
    {
      Message::send(msg::kWARNING,__FUNCTION__,"Dumping a backtrace...");
      int ctr=1;
