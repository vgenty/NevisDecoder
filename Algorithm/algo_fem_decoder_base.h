...
/** \addtogroup Algorithm
    ...
    @{*/
#ifndef ALGO_FEM_DECODER_BASE_H
#define ALGO_FEM_DECODER_BASE_H
...
namespace larlite {
  ...
  public:
	...
	module_address         = data::kINVALID_UCHAR;
	module_id              = data::kINVALID_UCHAR;
	event_number           = fem::kINVALID_WORD;
	event_frame_number     = fem::kINVALID_WORD;
	fem_trig_frame_number  = fem::kINVALID_WORD;
	fem_trig_sample_number = fem::kINVALID_WORD;
	nwords                 = 0;
	checksum               = 0;
	quality                = true;
      }
  ...
  public:
    ...
    virtual bool is_event_empty(){ return (_header_info.event_number == fem::kINVALID_WORD);};
  ...
  #define INCLUDE_EXTRA_HEADER
    ...
    static const size_t kFEM_HEADER_COUNT=6; ///< Number of event header words
  #else
    static const size_t kFEM_HEADER_COUNT=5; ///< Number of event header words
  #endif

    // variables
    UInt_t    _event_header_words[kFEM_HEADER_COUNT]; ///< Event header word holder
