/**
 * \file algo_slow_readout_decoder.h
 *
 * \ingroup Algorithm
 * 
...
/** \addtogroup Algorithm
    ...
    @{*/
#ifndef ALGO_SLOW_READOUT_DECODER_H
#define ALGO_SLOW_READOUT_DECODER_H

#include "algo_base.h"
#include "DataFormat/pmtfifo.h"
  ...
  public:
    ...
    */
    ...
    virtual bool is_event_empty(){ 
      if(_event_data) return (_event_data->event_id()==fem::kINVALID_WORD);
      else return true;
    };
...
#define INCLUDE_EXTRA_HEADER
  ...
  #endif
    static const size_t kCHANNEL_HEADER_COUNT=2; ///< Number of channel header words
    ...
    fem::Discriminator_t _last_disc_id;              ///< Holder of last channel data's disc. id
