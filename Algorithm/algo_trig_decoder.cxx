#ifndef ALGO_TRIG_DECODER_CXX
#define ALGO_TRIG_DECODER_CXX

#include "algo_trig_decoder.h"
...
namespace larlite {
  ...
  bool algo_trig_decoder::process_word(UInt_t word) {
    ...
    if(!_data){
      _data=(trigger*)(_storage->get_data<trigger>("trig"));
      if(!_data){
  ...
  bool algo_trig_decoder::decode_trigger_words(UInt_t *trigger_words){
	...
	<< std::endl;
      Message::send(msg::kINFO,__FUNCTION__,msg.str());
    }
