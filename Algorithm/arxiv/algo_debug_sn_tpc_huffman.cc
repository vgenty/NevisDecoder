#include "algo_debug_sn_tpc_huffman.hh"
...
namespace larlight {
  ...
  bool algo_debug_sn_tpc_huffman::process_word(const UInt_t word) {
	...
	Message::send(MSG::WARNING,__FUNCTION__,"DEBUG MODE => [vic] Continue onwards...\n");
  ...
  //#########################################################
    ...
    if(_verbosity[MSG::INFO]) Message::send( MSG::INFO,__FUNCTION__, "algo_debug_sn_tpc_huffman" );
