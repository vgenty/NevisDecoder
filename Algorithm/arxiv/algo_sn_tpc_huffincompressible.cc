#include "algo_sn_tpc_huffincompressible.hh"
...
namespace larlight {
							       ...
							       UInt_t &last_word)
  {
    ...
    else if ( ( last_word_class != FEM::CHANNEL_PACKET_LAST_WORD ) && ( last_word != 0x0 ) ) {
  ...
  //#########################################################
    ...
    if(_verbosity[MSG::INFO]) Message::send( MSG::INFO,__FUNCTION__, "algo_sn_tpc_huffincompressible" );
