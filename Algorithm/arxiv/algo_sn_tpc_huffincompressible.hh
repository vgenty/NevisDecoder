#ifndef ALGO_SN_TPC_HUFFINCOMPRESSIBLE_HH
#define ALGO_SN_TPC_HUFFINCOMPRESSIBLE_HH

#include "algo_tpc_huffman.hh"

namespace larlight {

  class algo_sn_tpc_huffincompressible : public algo_tpc_huffman {

  public:

    algo_sn_tpc_huffincompressible();

    virtual ~algo_sn_tpc_huffincompressible(){}
